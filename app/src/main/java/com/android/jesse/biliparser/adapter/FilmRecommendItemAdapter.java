 ...
 * @date: 2020/4/28
 */
public class FilmRecommendItemAdapter extends RecyclerView.Adapter<FilmRecommendItemAdapter.ViewHolder>{

    private static final String TAG = FilmRecommendItemAdapter.class.getSimpleName();

    private List<FilmRecommendItemBean.DataBean> dataBeanList;
    private Context mContext;

    public FilmRecommendItemAdapter(Context mContext, List<FilmRecommendItemBean.DataBean> dataBeanList) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, int position) {
        FilmRecommendItemBean.DataBean dataBean = dataBeanList.get(position);
