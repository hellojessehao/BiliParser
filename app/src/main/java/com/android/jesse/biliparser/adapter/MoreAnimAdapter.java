 ...
 * @date: 2020/4/29
 */
public class MoreAnimAdapter extends RecyclerView.Adapter<MoreAnimAdapter.ViewHolder>{
    ...
    public MoreAnimAdapter(Context context, List<MoreAnimItemBean> animItemBeanList){
        mContext = context;
